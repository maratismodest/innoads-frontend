...
export const seo: Record<string, Seo> = {
  default: {
    title: '01 - Пожарная барахолка',
    description:
      'Здесь можете купить, продать, обменять специализированное снаряжение и оборудование.',
  },
  profile: {
  ...
  auth: {
    ...
    description:
      'Вам нужно авторизоваться, прежде чем попасть в личный кабинет или подать объявление',
  },
  blog: {
    title: 'Блог',
  ...
  search: {
    title: 'Поиск в FireEquipment',
    description: 'Ищите объявления в бесплатной доске FireEquipment',
  },
  notFound: {
...
export const revalidate = Number(process.env.NEXT_PUBLIC_REVALIDATE) || 86400;
